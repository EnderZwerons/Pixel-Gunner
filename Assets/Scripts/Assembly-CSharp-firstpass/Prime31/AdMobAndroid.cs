...
namespace Prime31
{
	public class AdMobAndroid
	{
		...
		public static void setServeNonPersonalizedAds()
		{
			if (Application.platform == RuntimePlatform.Android)
			{
				_admobPlugin.Call("setServeNonPersonalizedAds");
			}
		}
		...
		public static void createNativeBanner(string adUnitId, int width, int height, AdMobAdPlacement placement)
		{
			if (Application.platform == RuntimePlatform.Android)
			{
				_admobPlugin.Call("createNativeBanner", adUnitId, width, height, (int)placement);
			}
		}
		...
		public static bool isRewardBasedAdReady()
		{
			if (Application.platform != RuntimePlatform.Android)
			{
				return false;
			}
			return _admobPlugin.Call<bool>("isRewardBasedAdReady", new object[0]);
		}
