...
namespace JsonFx.Json
{
	internal class TypeCoercionUtility
	{
		...
		private object CoerceList(Type targetType, Type arrayType, IEnumerable value)
		{
			...
			ParameterInfo[] array2 = ((method == null) ? null : method.GetParameters());
			Type type = ((array2 == null || array2.Length != 1) ? null : array2[0].ParameterType);
			...
			array2 = ((method == null) ? null : method.GetParameters());
			type = ((array2 == null || array2.Length != 1) ? null : array2[0].ParameterType);
			if (type != null)
			{
		...
		private static bool IsNullable(Type type)
		{
			...
			{
				return typeof(Nullable<>) == type.GetGenericTypeDefinition();
			}
			return false;
		}
	}
